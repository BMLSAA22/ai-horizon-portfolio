	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Custom colors for AI portfolio
				tech: {
					'deep-blue': '#1A1F2C',
					'purple': '#8B5CF6',
					'blue': '#0EA5E9',
			...
			backgroundImage: {
				...
				'tech-gradient': 'linear-gradient(to right, #1A1F2C, #2C243B)',
				'card-gradient': 'linear-gradient(135deg, rgba(139, 92, 246, 0.2) 0%, rgba(14, 165, 233, 0.05) 100%)',
			}
		}
	},
